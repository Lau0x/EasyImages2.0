...
try {
    ...
    error_log('EasyImage Lite setup error: ' . $exception->getMessage());
    http_response_code(500);
    header('Content-Type: text/plain; charset=utf-8');
    echo 'EasyImage Lite 配置错误，请检查服务器日志。';
    exit;
}
    ...
    if (!$rateLimiter->reserveAttempt()) {
        ...
        if (!LiteSetup::verifyToken($setupState, $setupToken)) {
            ...
            try {
                ...
                error_log('EasyImage Lite setup write error: ' . $exception->getMessage());
    ...
    <main class="setup-shell">
        ...
        <section class="setup-panel" aria-labelledby="setup-title">
            ...
            <form method="post" class="setup-form">
                ...
                <small id="token-help">在 Docker 日志中查找 “EasyImage Lite setup token”，有效至 <?= setupEscape($expiresAt->format('H:i')) ?>。</small>
