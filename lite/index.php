...
<head>
    ...
    <title>Darkroom — EasyImage Lite</title>
...
<?php if (!$authenticated): ?>
    <main class="login-shell">
        <section class="login-panel">
            <p class="eyebrow">EasyImage Lite / 私有工作台</p>
            <h1>进入暗房</h1>
...
<?php else: ?>
    ...
    <main class="main-grid">
        <section class="hero">
            <div><p class="eyebrow">无数据库图床 / <?= liteEscape($date->format('Y.m.d')) ?></p><h1>把图片放进<br><em>自己的暗房。</em></h1></div>
    ...
    <footer><span>EasyImage Lite</span><span>Filesystem first · <?= liteEscape($liteConfig['timezone']) ?></span></footer>
<?php endif; ?>
