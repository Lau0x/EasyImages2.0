...
<head>
    ...
    <title>药剂柜 · EasyImage Lite</title>
...
<body class="token-page">
    <header class="topbar token-topbar">
        <a class="brand" href="<?= liteEscape(liteAppUrl($liteConfig)) ?>"><b>DR</b><span>EasyImage<br>Lite</span></a>
    ...
    <footer><span>EasyImage Lite / API Cabinet</span><span>Token hashes only · <?= liteEscape($liteConfig['timezone']) ?></span></footer>
